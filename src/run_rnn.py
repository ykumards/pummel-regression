...
trainer = Trainer(dataset=dataset, model=rnn_model, args=args, writer=writer)
...
trainer.plot_performance(
    filename=f"{args.exp_name}_{datetime.datetime.now().strftime('%m_%d_%H_%M')}_train.png"
)
trainer.plot_residuals(
    filename=f"{args.exp_name}_{datetime.datetime.now().strftime('%m_%d_%H_%M')}_residuals.png"
)
